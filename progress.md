...
| Logging | ✅ | `logging.c` (levels, colour) |
| Event system + input | 🟡 | Works; `handled` consumption being added (input-only — ADR-0002). Still one shared event object er category (ADR-0001) |
